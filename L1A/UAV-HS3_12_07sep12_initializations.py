...
proj_name = 'UAV-HS3_12'
flt_date = '07sep12' # in "CPL" form, not "CAMAL" form
sortie = '12-203'

# ******** SET THE TIME RANGE BOUNDARIES FOR DATA PROCESSING ********
process_start = DT.datetime(2012,9,1,0,0,0) #yr,mon,dy,hr,min,sec
process_end   = DT.datetime(2012,10,13,0,0,0)
...
ff_bot_alt,ff_top_alt = [-7e3,22.005e3]
...
overlap_file = 'olaptable_cpl-022013_comb_attrex13.xdr'
...
# Character string bar allowing text output to terminal to be more noticeable
attention_bar = '\n******************************\n'
