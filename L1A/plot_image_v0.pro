PRO plot_image_v0,data,x,y,absmax,posvec,xtotsize,ytotsize,tit1,tit2,xtit,ytit,cbtit,filename,num_x_axes,x2,x3
...
colorbar2,maxrange=absmax,position=cbpos,division=4,charsize=littlechar,/vertical,/right,color=0
