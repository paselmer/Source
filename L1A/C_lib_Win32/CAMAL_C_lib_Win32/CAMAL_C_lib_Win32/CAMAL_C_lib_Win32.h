...
#ifdef CAMAL_C_LIB_WIN32_EXPORTS
#define CAMAL_C_LIB_WIN32_API __declspec(dllexport) 
#else
#define CAMAL_C_LIB_WIN32_API __declspec(dllimport) 
#endif

CAMAL_C_LIB_WIN32_API void rebin_into_fixed_frame(double *ff, double *af, double *or, double *NEW,
	...
	double *mult);
CAMAL_C_LIB_WIN32_API void rebin_into_fixed_frame_v2(double *ff, double *af, double * or , double *new,
...
CAMAL_C_LIB_WIN32_API void map_interp_times_to_orig_frame(double *NEW, double *ORIG, double *INTERP,
