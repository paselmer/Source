...
dset = '20171205'
tit_tag = 'CAMAL 05 Dec 17'
filename = '/cpl3/CAMAL/Data/CAMAL_17/'+dset+'/L1/NRB_CAMAL_17_'+dset+'_nav.hdf5'
...
valid_locs = where((surface_alt gt -9999.0) and (meta.scan_state eq 1),nv)
if (nv gt 0) then begin
    ...
    ONA = ONA[valid_locs]
    scan_state = meta[valid_locs].scan_state
