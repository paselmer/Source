...
proj_name = 'Iceax11'
flt_date = '06apr11' # in "CPL" form, not "CAMAL" form
sortie = '11-633'

# ******** SET THE TIME RANGE BOUNDARIES FOR DATA PROCESSING ********
process_start = DT.datetime(2000,8,6,15,48,25) #yr,mon,dy,hr,min,sec
...
pp_xax_bounds_raw_counts = [0,150]
pp_xax_bounds_bgsub_counts = [-15,70]
pp_xax_bounds_NRB = [-7e8,1e10]
