PRO plot_image_vc,data,x,y,absmax,posvec,xtotsize,ytotsize,tit1,tit2,xtit,ytit,cbtit,filename,num_x_axes,x2,x3
...
;
;vc is a version for making custom plots -> things that don't fit a cookie-cutter process.
...
;cdtit      -> The title of the color bar
...
;/*** FORM IMAGE ***\ ;<------------------------------------------------ EDIT HERE
loadct,10
COMMON COLORS, R_orig, G_orig, B_orig, R_curr, G_curr, B_curr
data = alog10(data) + 3.0 
ODmax=3.0 ; <-- I was OD max of this #
absmax=alog10(ODmax) + 3.0
...
colorbar2,maxrange=absmax,position=cbpos,division=4,charsize=littlechar,/vertical,/right,color=0,/custom_ticks
