...
PRO cats_images_mode72_ge,config_path
...
dum=''
openr,clun,config_path+'cats_images_mode72_ge.config',/get_lun
...
if (file_path ne 'x') then begin
    infile = file_search(file_path,file_name)
    infile = infile[0]
endif else begin
...
if (ntl2 eq 0) then begin
    ...
    erec=erec[0]
endelse
altitude = bin_altitude_array+0.5 ;added X km [11/20/17]
